...
Bitcoin <-  ts(BITCOIN$Fechado, start = 2014, frequency = 365)
...
acf(BITCOIN$Fechado,lend=2, lwd=5,col="darkblue",main= "Função Autocorrelação - FAC")              #Melhorando aspecto da FAC
axis(1,tck = 1, col = "lightgrey", lty = "dotted")

pacf(BITCOIN$Fechado,lend=60, lwd=5,col="darkblue",main= "Função Autocorrelação Parcial - FACP")   #Melhorando aspecto da PAC
axis(1,tck = 1, col = "lightgrey", lty = "dotted")
...
IntOrdem1 <- diff(BITCOIN$Fechado)
