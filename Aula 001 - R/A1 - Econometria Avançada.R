...
# Instruções para criação de uma Matriz

m<-matrix(nrow=2, ncol=2) #nrow é comnado utilizado para número de linhas, ncol é o comando utilizado para número de colunas
m #matriz m
